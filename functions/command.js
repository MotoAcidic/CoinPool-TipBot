...
module.exports = {
    ...
    command_testrule: async function (userID, userName, messageType, msg) {
       ...
       /* //Rule 2 (Clock Drift)
        if (ruleNumber2 == undefined) { chat.chat_reply(msg, 'embed', false, messageType, config.colors.success, false, config.messages.testrule.rule2ON, false, [config.messages.testrule.currentBlock, currentBlock], false, false, false, false);
        }else{ chat.chat_reply(msg, 'embed', false, messageType, config.colors.success, false,config.messages.testrule.rule2OFF, false,[config.messages.testrule.currentBlock, currentBlock], false, false, false, false);}
        //Rule 3 (POS Percent)
